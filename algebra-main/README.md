...
//若图片无法显示请直接在homework_picture文件夹中查阅

![+](homework_picture\add.png)
//将两个矩阵对应位置的数相加，循环实现

![-](homework_picture\sub.png)
//将两个矩阵对应位置的数相减，循环实现

![*](homework_picture\cheng.png)
//分别遍历两个矩阵对应的行和列，对应值相乘后相加得到对应位置的新值

![.](homework_picture\shucheng.png)
//遍历每个数字并乘上所给数值

![t](homework_picture\t.png)
//交换行列的下标

![d](homework_picture\hanglieshi.png)
//使用递归实现

![i](homework_picture\i.png)
//使用学长所给资料的思路

![r](homework_picture\r.png)
//使用学长所给资料的思路

![j](homework_picture\j.png)
//将对角线的各个数字相加即可
